...
class Constants {
    ...
    static final String BASE_URL = "http://www.callawaygolf.com";
    static final String CATEGORY_URL = "http://www.callawaygolf.com/golf-clubs/?sz=12&start=%data%&format=page-element";
    static final String PRODUCT_URL = "http://www.callawaygolf.com/on/demandware.store/Sites-CG-Site/en_US/ProductSpecs-Get?productCode=%data%&amp;locale=en-US";
    ...
    static final String CLASS_NAME = "table table-striped";
    ...
    static final String CART_ITEM_CLASS = "lineItemDescription";
